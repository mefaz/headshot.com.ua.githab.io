        ...
        var setup = function() {
            ...
            if (pgwSlideshow.slideCount > 1) {
                ...
                if (pgwSlideshow.config.displayControls) {
                    $('html').find('.ps-currents').prepend('<span class="ps-prev"><i class="fa fa-chevron-left" aria-hidden="true"></i></span>');
                    $('html').find('.ps-currents').append('<span class="ps-next"><i class="fa fa-chevron-right" aria-hidden="true"></i></span>');
                    $('html').find('.ps-currents .ps-prev').click(function() {
                        pgwSlideshow.previousSlide();
                    });
                    $('html').find('.ps-currents .ps-next').click(function() {
            ...
            if (pgwSlideshow.config.displayList) {
                ...
                pgwSlideshow.plugin.find('.ps-list').prepend('<span class="ps-prev"><span class="ps-prevIcon 1"></span></span>');
                pgwSlideshow.plugin.find('.ps-list').append('<span class="ps-next"><span class="ps-nextIcon 2"></span></span>');
